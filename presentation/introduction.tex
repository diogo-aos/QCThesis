...
\end{figure}
%\footnote{A. N. L. Fred and A. K. Jain, “Combining multiple clusterings using evidence accumulation,” IEEE Transactions on Pattern Analysis and Machine Intelligence, vol. 27}
...
\centering
\begin{tabular}{ccc}
  \includegraphics[width=0.3\textwidth]{EAC_plots/raw_data} &  & \includegraphics[width=0.3\textwidth]{EAC_plots/kmeans1} \\
...
\centering
\begin{tabular}{ccc}
  \includegraphics[width=0.3\textwidth]{EAC_plots/kmeans1} &   \includegraphics[width=0.3\textwidth]{EAC_plots/coassoc1} & \includegraphics[width=0.3\textwidth]{EAC_plots/coassocEAC}  \\

  {\tiny (a)} & {\tiny (c)} & {\tiny (e)} \\

  \includegraphics[width=0.3\textwidth]{EAC_plots/kmeans2} &  \includegraphics[width=0.3\textwidth]{EAC_plots/coassoc2} & \\
...
\centering
\begin{tabular}{cc}
  \includegraphics[width=0.3\textwidth]{EAC_plots/coassocEAC} &   \includegraphics[width=0.3\textwidth]{EAC_plots/eac}  \\
