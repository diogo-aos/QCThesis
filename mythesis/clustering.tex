...
%similarity
Finally, a \emph{similarity measure} is a way of quantifying how similar two patterns are in the feature space. In contrast, a \emph{dissimilarity measure} measures how dissimilar two patterns are.  Examples of this measures are a metric (such as the euclidean distance) and the Pearson correlation coefficient.%TODO reference for a method for both euclidean distance and Pearson correlation
