...
% \begin{align}
%     d(\mathbf{x}_i, \mathbf{x}_i) = 0 \qquad (identity) \label{eq:identity} \\
%     d(\mathbf{x}_i, \mathbf{x}_j) = d(\mathbf{x}_j, \mathbf{x}_i), i \neq j \qquad (symmetry)  \label{eq:symmetry} \\
%     d(\mathbf{x}_i, \mathbf{x}_j) + d(\mathbf{x}_j, \mathbf{x}_z) \ge d(\mathbf{x}_x, \mathbf{x}_z) \qquad (triangle \; inequality) \label{eq:triangle inequality}
% \end{align}
