...
Such complexity becomes prohibitive for big data, e.g. a dataset of $2 \times 10^6$ patterns will result in a complete co-association matrix of $14901 \; GB$ if values are stored in single floating-point precision.
...
% Still, this highly depends on the the number of neighbors relative to the number of patterns and also the granularity of the partitions.
