...
The main contributions are the adaptation of the three distinct stages of the EAC toolchain to larger datasets.% and make each stage work with the others.
