...
del label_centroid_pairs['numpy'] #don't compute with python   
del label_centroid_pairs['numba'] #don't compute with python   
...
round_time_change = 600 # after this many seconds, change to 1 round
